<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="kayit2.aspx.cs" Inherits="kayit2" Title="Untitled Page" %>
			...
			<div class="post">
				<div class="entry">
					<table cellspacing="20">
					    ...
					    <tr>
					        <td> <asp:Button ID="btnSignUp" runat="server" Text="Kayıt ol" ValidationGroup="signUp" OnClick="btnSignUp_Click" /></td>
					    </tr>
					</table>
				</div>
			</div>
